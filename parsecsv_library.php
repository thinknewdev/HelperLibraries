...
*/
	...
	/*function __construct() {
		if ( $params['offset'] !== null ) $this->offset = $offset;
		if ( $params['limit'] !== null ) $this->limit = $limit;
		if ( count($params['conditions']) > 0 ) $this->conditions = $conditions;
		if ( !empty($params['input']) ) $this->parse($input);
